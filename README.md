...
# 📖 [LibraExchange] <a name="about-project"></a>

**Libra Exchange** is a project that allows users to see the of NYSE stocks in real time. It is built with React and Redux.
...
```sh
  mkdir weather-app
  cd weather-app
  git clone https://github.com/Zven94/react-capston.git
```
